...
const useStyles = makeStyles((theme) => ({
  ...
  drawerPaper: {
    top: theme.spacing(10), // Adjust this value to match the height of NavigationBar
    height: `calc(100% - ${theme.spacing(11)})`, // Adjust the height accordingly
    borderRadius: theme.spacing(1),
    marginRight: theme.spacing(1), // Add a small space between the right edge and the component
  },
}));
